...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LCTL, KC_Z,    KC_X,          KC_C,    KC_V,           KC_B,    KC_N,    KC_M,           KC_COMM, KC_DOT,  KC_SLSH, KC_MINS, \
                      LALT_T(KC_F5), KC_BSPC, RSFT_T(KC_SPC), TT(2),   TT(1),   RCTL_T(KC_ENT), KC_DEL,  KC_F12                     \
  ),
  /* Lower
   * ,-----------------------------------------.             ,-----------------------------------------.
  ...
  [_RAISE] = LAYOUT( \
    ...
    RGB_MOD, KC_1,    KC_2,     KC_3,     KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_PPLS, _______, \
    RGBRST, KC_AT,   KC_HASH,  KC_DLR,   KC_PERC, KC_LCBR, KC_RCBR, KC_4,    KC_5,    KC_6,    KC_PCMM, _______, \
    RGB_RMOD, KC_CIRC, KC_AMPR,  KC_ASTR,  KC_EXLM, KC_LBRC, KC_RBRC, KC_1,    KC_2,    KC_3,    KC_PEQL, _______, \
                      _______,  _______,  _______, _______, _______, KC_0,    KC_00,   KC_PDOT                    \
  ),
  ...
  [_ADJUST] =  LAYOUT( \
    ...
    RGB_MOD, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______, \
                      _______, _______, _______,  RGBRST, _______, _______,  _______, _______                    \
  )
};
#else
