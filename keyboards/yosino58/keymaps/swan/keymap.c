 ...
 */
 [_QWERTY] = LAYOUT( \
  ...
  KC_LCTRL, KC_Z, KC_X, KC_C, KC_V,          KC_B,    KC_LBRC,        CALC, CUSL, KC_RBRC,        KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_MINS, \
                              LALT_T(KC_F5), KC_BSPC, LCTL_T(KC_SPC),             LSFT_T(KC_ENT), KC_DEL, KC_F12\
  ),
 ...
 */
 [_LOWER] = LAYOUT( 
  ...
  _______, KC_F3,   KC_HOME,    KC_PGDN, KC_END,     KC_F3,                                        KC_F8,   KC_LEFT,      KC_DOWN,      KC_RGHT,      KC_F8,   KC_F11,  \
  _______, _______, C(KC_LEFT), _______, C(KC_RGHT), _______,   KC_LPRN, ADJUST, _______, KC_RPRN, _______, LCA(KC_LEFT), LCA(KC_DOWN), LCA(KC_RGHT), _______, _______, \
