 ...
 */
 [_QWERTY] = LAYOUT( \
  ...
  KC_LCTRL, KC_Z, KC_X, KC_C, KC_V,    KC_B,     KC_DEL, LOWER, RAISE, KC_BSPC,    KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_BSLS, \
                              KC_LALT, KC_HENK, KC_SPC,               KC_ENT,     KC_LBRC, KC_RBRC\
  ),
 ...
 */
 [_LOWER] = LAYOUT( \
  ...
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, _______,  _______, XXXXXXX, _______, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_PAUS, KC_F12, \
                                      DELBNDS,  AD_WO_L, _______,                    _______, KC_RGUI, KC_RALT\
 ...
 * |      |   !  |   @  |   #  |   $  |   %  |                                  |   ^  |   &  |   *  |   (  |   )  |  _   |
 * |------+------+------+------+------+------|                                  |------+------+------+------+------+------|
 * |LShift|      | MBTNR| MBTNM| MBTNL|      |                                  | MWHU | MWHL | MSU  | MWHR |      |  +   |
 * |------+------+------+------+------+------|                                  |------+------+------+------+------+------|
 * |LCTRL |      | MACL0| MACL1| MACL2|      |-------.-------.  ,---------------| MWHD | MSL  | MSD  | MSR  |      |      |
 * `-----------------------------------------/  Del  /       /   \       \ Bksp  \----------------------------------------'
 *                          | LAlt | LGUI | /-------/       /     \ RAISE \-------\  |      |      |
 *                          |      |      |/ Space /       /       \       \ Enter \ |      |      |
 *                          `-----------------------------'         '------------------------------'
 */
 [_RAISE] = LAYOUT( \
  ...
  _______, XXXXXXX, KC_BTN2, KC_BTN3, KC_BTN1,  XXXXXXX,                                     KC_WH_U, KC_WH_L, KC_MS_U, KC_WH_R, XXXXXXX, KC_PLUS, \
  _______, XXXXXXX, KC_ACL0, KC_ACL1, KC_ACL2,  XXXXXXX, _______, XXXXXXX, _______, _______, KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_R, XXXXXXX, XXXXXXX, \
                                      KC_LALT,  KC_LGUI, _______,                   _______, XXXXXXX, XXXXXXX \
  ),
